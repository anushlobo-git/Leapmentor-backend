 ...
 * @route   POST /api/escrow/pay-additional
 * @access  Private (Mentee)
 */
 ...
 * @route   POST /api/escrow/release/:requestId
 * @access  Private (Mentee)
 */
 ...
 * @route   POST /api/escrow/refund/:requestId
 * @access  Private (User)
 */
 ...
 * @route   GET /api/escrow/status/:requestId
 * @access  Private (User)
 */
 ...
 * @route   GET /api/escrow/commission-rate
 * @access  Private (User)
 */
