...
// One per user per session — duplicate returns 409
// ─────────────────────────────────────────────────────────────
const submitFeedback = async (req, res) => {
  try {
    ...
    // ✅ Only completed sessions can receive feedback
...
// Returns:
//   myFeedback    — feedback this user submitted (or null)
//   theirFeedback — feedback the other party submitted (or null)
...
const getFeedback = async (req, res) => {
  try {
    ...
    return res.json({
      success:       true,
      myFeedback,
      // ✅ Only reveal their feedback if session is completed
